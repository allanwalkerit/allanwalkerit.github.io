  ...
  },
  {
      ...
      opacity: 0
        ...
        },
        {
            ...
            image: '',
            description: "<div id='tableauViz4' class='tableauPlaceholderfixed'></div><b>Rotate &#x293F;</b><input id='sliderd' class='tableauSlider' type='range' min='1' max='63' step='1' value='1' /><br>The Statue of Liberty (Liberty Enlightening the World); French: La Liberté éclairant le monde) is a colossal neoclassical sculpture on Liberty Island in New York Harbor in New York, in the United States. The copper statue, a gift from the people of France to the people of the United States, was designed by French sculptor Frédéric Auguste Bartholdi and its metal framework was built by Gustave Eiffel. The statue was dedicated on October 28, 1886.<br><br>The Statue of Liberty is a figure of Libertas, a robed Roman liberty goddess. She holds a torch above her head with her right hand, and in her left hand carries a tabula ansata inscribed in Roman numerals with 'JULY IV MDCCLXXVI' (July 4, 1776), the date of the U.S. Declaration of Independence. A broken shackle and chain lie at her feet as she walks forward, commemorating the recent national abolition of slavery. The statue became an icon of freedom and of the United States, and a national park tourism destination. It is a welcoming sight to immigrants arriving from abroad.<br><br><center><b><i>3D Model in STL format by 'Yoshi Tomoimura' of 'Imura Works' under Personal Use licence<br>Converted for Tableau using Alteryx Gallery App by Philipp Riggs</i></b></center>",
            location: {
